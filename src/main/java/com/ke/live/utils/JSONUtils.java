...
public class JSONUtils {
    ...
    public static void setAnnotationIntrospector(AnnotationIntrospector annotationIntrospector) {
        AnnotationIntrospector sis = mapper.getSerializationConfig().getAnnotationIntrospector();
        AnnotationIntrospector ai = AnnotationIntrospectorPair.pair(sis, annotationIntrospector);
